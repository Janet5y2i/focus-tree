...
const API_ERROR_EN: Record<string, string> = {
  ...
  "請選擇至少一種心情，或寫下自訂心情":
    "Please choose at least one mood, or write a custom one",
  "自訂心情最多 40 字": "Custom mood can be at most 40 characters",
  "一次最多選 8 種心情": "You can pick at most 8 moods at once",
  "請提供至少一棵目標樹": "Please provide at least one goal tree",
  "一次最多排序 12 棵目標樹": "You can reorder at most 12 trees at once",
  "目標樹不可重複": "Goal trees can’t be duplicated",
  "排序資料無效": "Invalid ordering data",
  "排序內容與目前進行中的目標樹不一致":
    "The order no longer matches the current in-progress trees",
  "儲存排序失敗，請稍後再試": "Couldn’t save the goal order. Please try again.",
